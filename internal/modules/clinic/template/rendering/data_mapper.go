...
// DataMapper handles conversion of invoice data to template-compatible maps
...
// ToMap converts any struct to a map for template rendering
...
// MergeData merges multiple data maps into one
