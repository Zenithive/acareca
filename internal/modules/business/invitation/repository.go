...
type Repository interface {
	...
	UpdateStatus(ctx context.Context, tx *sqlx.Tx, id uuid.UUID, status InvitationStatus, entityID *uuid.UUID) error
}
...
func (r *repository) DeletePermission(ctx context.Context, tx *sqlx.Tx, entityID uuid.UUID) error {
...
func (r *repository) UpdateStatus(ctx context.Context, tx *sqlx.Tx, id uuid.UUID, status InvitationStatus, entityID *uuid.UUID) error {
...
func (r *repository) LinkPermissionsToAccountant(ctx context.Context, tx *sqlx.Tx, email string, accountantID uuid.UUID) error {
	query := `
